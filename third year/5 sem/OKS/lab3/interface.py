        ...
        if self.com_send:
            ...
            if data:
                ...
                for i in range(0, len(data), 16):
                    ...
                    output_stuffed_packets.append(output_packet)

                self.update_status(f"Сформированные пакеты:")
                for packet in output_stuffed_packets:
                    self.update_status(f"{packet}")
                self.number_send += 1
        ...
        while self.is_receiving:
            if self.com_receive:
                ...
                if data:
                    ...
                    if '\n' in received_message:
                        complete_message = received_message.split('\n')[0]
