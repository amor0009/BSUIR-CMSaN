...
struct s1																		// шаблон структуры
{
	...
	char* country;																// название страны, импортирующей товар
	int volume;																	// объём экспорта данного товара
};

int InputInfoInStruct(struct s1 ** info)										// ввод информации в массив структур
{
...
void FindProduct(struct s1* inf, int n)											// поиск нужных полей структуры и их вывод
{
	...
	if (flag == 0)																// если flag = 0, то такого товара нет
